  ...
  return (
    <div className="bg-background border-b border-border p-6 md:p-8 lg:p-10 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <AnimateOnScroll delay={200}>
        <Button className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 text-text-regular rounded-full shadow-md transition-all duration-300 ease-in-out hover:scale-[1.02]">
